...
public class CartPage extends BasePage {
    ...
    public boolean isProductInCart(String productId) throws IllegalAccessException {
        waitForShopTable();
        ...
        if (productRecords == 1){
            ...
            throw new IllegalAccessException("There is more than one record for the product in cart.");
        }
    ...
    public boolean isCartEmpty() throws IllegalAccessException {
        ...
        if(shopTableElements == 1){
            ...
            throw new IllegalAccessException("Wrong number of shop table elements: There can be only one on none");
        }
    }

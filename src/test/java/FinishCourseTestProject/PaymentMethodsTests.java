package FinishCourseTestProject;
...
public class PaymentMethodsTests {
    ...
    public void ordinarySuccessfulPaymentTest(){
        ...
        fillOutCheckoutForm();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#order_review")));
        insertCardNumber("378282246310005");
        insertCardExpirationDate("0225");
        insertCardCvcCode("123");
    ...
    public void secureSuccessfulPaymentTest(){
        ...
        fillOutCheckoutForm();
        insertCardNumber("4000000000003220");
        insertCardExpirationDate("0225");
        insertCardCvcCode("123");
        driver.findElement(regulationCheckbox).click();
    ...
    private void fillOutCheckoutForm(){
        wait.until(ExpectedConditions.elementToBeClickable(firstNameField)).sendKeys("Ola");
        wait.until(ExpectedConditions.elementToBeClickable(lastNameField)).sendKeys("Nowak");
        wait.until(ExpectedConditions.elementToBeClickable(countryCodeArrow)).click();
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("li[id*='-BE']"))).click();
        ...
        wait.until(ExpectedConditions.elementToBeClickable(phoneField)).sendKeys("6666666");
